...
(function ($) {
    ...
    function _13c(_13d, _13e, _13f) {
        ...
        if (ul.length) {
            ...
            var _140 = $("<ul></ul>").insertAfter(_13e);
...
(function ($) {
    ...
    $.fn.progressbar.defaults = {
        width: "auto", height: 24, value: 0, text: "{value}%", onChange: function (_1e9, _1ea) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _21d(_21e) {
                    ...
                    if (opts.tools) {
                        if ($.isArray(opts.tools)) {
                            $.map(opts.tools, function (t) {
                                _227(tool, t.iconCls, eval(t.handler), t);
                            });
                        } else {
        ...
        function _227(c, icon, _228, t) {
            var a = $("<a href=\"javascript:void(0)\"></a>").addClass(icon).appendTo(c);
            if (t && t.title) {
                a.attr("title", t.title);
            }
            a.bind("click", _228);
...
(function ($) {
    ...
    function init(_3a3) {
        ...
        function _3a4(cc) {
            //2015-12-13huang修改
            var opts;
            if (cc[0].tagName == "FORM") {
                opts = cc.parent().layout("options");
            } else {
                opts = cc.layout("options");
            }
            //-----------
            var _3a5 = opts.onAdd;
            opts.onAdd = function () {
        ...
        //huang layout布局可以放在form标签内，也可以直接放在form标签外
        //cc.children("form").length  ? _3a4(cc.children("form")) : _3a4(cc);
        var _cc = cc;
        var form = cc.children("form");
        if (form.length > 0) {
            if (form.children("div[data-options]").length > 0) {
                _cc = form;
            }
        }
        _3a4(_cc);
    ...
    function _3a8(_3a9, _3aa, el) {
        ...
        if (opts.height) {
            if (opts.height < 1) {
                ...
                if (cc[0].tagName == "BODY") {
                    _height = cc[0].scrollHeight * opts.height;
                }
                else {
                    if (cc[0].tagName == "FORM") {
                        var parent = cc.parent();
                        if (parent[0].tagName == "BODY") {
                            _height = parent[0].scrollHeight * opts.height;
                        } else {
                            _height = parent.height() * opts.height;
                        }
                    } else {
                        if (cc.height() > 0) {
        ...
        //--------------------------------------------
        var _3ac = $.extend({}, $.fn.layout.paneldefaults, _3aa, {
            width: _width, height: _height, doSize: false, collapsible: true, onOpen: function () {
        ...
        }, { cls: ((_3aa.cls || "") + " layout-panel layout-panel-" + dir), bodyCls: ((_3aa.bodyCls || "") + " layout-body") });
        pp.panel(_3ac);
        _3ab[dir] = pp;
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 120, itemHeight: 24, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        width: "auto", height: 24, prompt: "", value: "", type: "text", multiline: false, editable: true, disabled: false, readonly: false, icons: [], iconCls: null, iconAlign: "right", iconWidth: 18, buttonText: "", buttonIcon: null, buttonAlign: "right", inputEvents: {
            blur: function (e) {
                var t = $(e.data.target);
...
(function ($) {
                ...
                for (var i = 0; i < opts.toolbar.length; i++) {
                    ...
                    if (btn == "-") {
                        ...
                        if (btn.indexOf("<") > -1 && btn.indexOf(">") > -1) {
                            $("<div class=\"easyui-toolbar-div\">" + btn + "</div>").appendTo(tr);
                        } else {
                            $("<div class=\"easyui-toolbar-div\" style=\"float:left;margin:5px 4px 5px 2px;\">" + btn + "</div>").appendTo(tr);
                        }
                    }
                    else {
                        ...
                        if (btn.type == 'combobox') {
                            tool.css("float", "left").appendTo(tr).combobox($.extend({}, btn));
                        } else if (btn.type == 'menubutton') {
                            tool.css("float", "left").appendTo(tr).menubutton($.extend({}, btn));
                        } else {
                            tool.css("float", "left").appendTo(tr).linkbutton($.extend({}, btn, { plain: true }));
                        }
    ...
    function _63d(e) {
        ...
        if (tt.parent().hasClass("datagrid-cell-check")) {
            ...
            //zhouwg增加键盘事件
            opts.onEndClickRow.apply(_63e, _5d0(_63e, [_63f, row]));
        }
    };
    function _647(e) {
        var tr = _637(e.target);
    ...
    function _709(_70a, _70b) {
        ...
        if ($(_70a).datagrid("getPager").length > 0) {
            var pager = $(_70a).datagrid("getPager").pagination("options");
            $(_70a).datagrid("getPager").pagination("refresh", { pageNumber: pager.pageNumber, pageSize: pager.pageSize, total: (pager.total - 1) });
        } else {
            $(_70a).datagrid("getPager").pagination("refresh", { total: data.total - 1 });
        }
        //zhouwg deleterow删除行后需要刷新
        if (opts.view.onAfterRender) {
            opts.view.onAfterRender.call(opts.view, _70a);
        }
    };
    ...
    function _713(_714, row) {
        ...
        _715.push(row);
        if ($(_714).datagrid("getPager").length > 0) {
            var pager = $(_714).datagrid("getPager").pagination("options");

            $(_714).datagrid("getPager").pagination("refresh", { pageNumber: pager.pageNumber, pageSize: pager.pageSize, total: (pager.total + 1) });
        } else {
            $(_714).datagrid("getPager").pagination("refresh", { total: data.total + 1 });
        }

        //zhouwg  appendrow后需要刷新
        var opts = $.data(_714, "datagrid").options;
        if (opts.view.onAfterRender) {
            opts.view.onAfterRender.call(view, _714);
        }
    ...
    var _790 = {
        render: function (_791, _792, _793) {
            ...
            for (var i = 0; i < _7a4.length; i++) {
                ...
                if (col) {
                    ...
                    if (!opts.hideQuickView) {
                        if (col.formatter) {
                            var title = col.formatter(_7aa, _7a7, _7a6);
                            if (title) {
            ...
            if (opts.finder.getRows(_7d3).length == 0) {
                ...
                //zhouwg
                //                $(_7d3).datagrid('getPanel').find('div.datagrid-body>table').css("border-bottom-width", "0px");
                //                $(_7d3).datagrid('getPanel').find('div.datagrid-body-inner>table').css("border-bottom-width", "0px");
            }
            else {//zhouwg添加else逻辑
                var vc = $(_7d3).datagrid('getPanel').children('div.datagrid-view');
                vc.children('div.datagrid-empty').remove();

                //                $(_7d3).datagrid('getPanel').find('div.datagrid-body>table').css("border-bottom-width", "1px");
                //                $(_7d3).datagrid('getPanel').find('div.datagrid-body-inner>table').css("border-bottom-width", "1px");
            ...
            //zhouwg
            var vc = $(_7d6).datagrid('getPanel').children('div.datagrid-view');
            vc.children('div.datagrid-empty').remove();
            var data = $.data(_7d6, "datagrid").data;
            var opts = $.data(_7d6, "datagrid").options;
            var d = $('<div class="datagrid-empty"></div>').html(opts.emptyMsg || '没有找到您要的相关数据').appendTo(vc);
            d.css({
                margin: '30px 0 0 0',
                color: '#f00',
                width: '100%'
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        }, onEndLoad: function () {//zhouwg增加键盘事件
        }, onEndClickRow: function () { }
    });
})(jQuery);
(function ($) {
    var _813;
...
(function ($) {
    ...
    function _889(_88a, _88b, data, _88c) {
        ...
        //zhouwg增加键盘事件
        if (opts.onEndLoad) {
            opts.onEndLoad.call(_88a, node, data);
        }
    };
    ...
    function _8b1(_8b2, _8b3) {
        ...
        if (_8b4.length) {
            ...
            var _8b4 = tr.next("tr.treegrid-tr-tree");
            var cc = _8b4.children("td").children("div");
            //cc.hide();//huang修改，treegrid列表第一次展开加载数据默认隐藏
        ...
        render: function (_8ed, _8ee, _8ef) {
            ...
            for (var i = 0; i < _904.length; i++) {
                ...
                if (col) {
                    ...
                    if (!opts.hideQuickView) {
                        if (col.formatter) {
                            var title = col.formatter(row[_907], row);
                            if (title) {
                                if (title.indexOf && (title.indexOf("<") > -1 || title.indexOf("/>") > -1)) {
...
(function ($) {
    ...
    $.fn.combogrid.defaults = $.extend({}, $.fn.combo.defaults, $.fn.datagrid.defaults, {
        height: 24, loadMsg: null, idField: null, textField: null, unselectedValues: [], mappingRows: [], mode: "local", keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
